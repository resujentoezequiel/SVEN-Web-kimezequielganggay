...
{{--                        <img src="url('<?php echo asset('storage/welcome_bg.jpg')?>')" alt="">--}}
                        <div>
                            <img src="{{ asset('/img/dog.png') }}" style="height: 6vh">
                        </div>
{{--                        <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />--}}
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <ul>
                        <li class="nav-item">
                            <a href="#about" class="nav-link scroll-smooth">About Us</a>
                        </li>
                    </ul>

                    <ul style="margin-left: 2rem">
                        <li class="nav-item">
                            <a href="#visit" class="nav-link scroll-smooth">Schedule a visit</a>
                        </li>
                    </ul>
